...
public static class GameDataManager
{
    ...
    public static void InitGameData()
    {
        ...
        ItemPrefabSO[] itemPrefabs = Resources.LoadAll<ItemPrefabSO>("193350/Item");
        ...
        GameObject[] prefabs = Resources.LoadAll<GameObject>("193350/Prefabs");

        foreach (var prefab in prefabs)
            resourcesRegistry.Add((prefab.name, typeof(GameObject)), prefab);

        Material[] materials = Resources.LoadAll<Material>("193350/Materials");
