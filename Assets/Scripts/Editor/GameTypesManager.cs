...
public class GameTypesManager : UnityEditor.AssetModificationProcessor
{
    private static readonly string SO_PATH = "Assets/ScriptableObjects";
    private static string OUTPUT_PATH => Path.Combine(Application.dataPath, "Scripts/AutoGenerated-DO_NOT_TOUCH");

    public static string[] OnWillSaveAssets(string[] paths)
    {
        (string path, bool found)[] search = 
        {
            ( "Assets/ScriptableObjects/Entity", false ),
            ( "Assets/ScriptableObjects/Items", false )
        };
